...
class AgentGoalAccuracyWithReference(BaseMetric):
    ...
    Usage:
        ...
        >>> from ...metrics.collections import AgentGoalAccuracyWithReference
        >>> from ...messages import HumanMessage, AIMessage, ToolMessage
        >>>
        >>> client = AsyncOpenAI()
...
class AgentGoalAccuracyWithoutReference(BaseMetric):
    ...
    Usage:
        >>> from openai import AsyncOpenAI
        >>> from ...llms.base import llm_factory
        >>> from ...metrics.collections import AgentGoalAccuracyWithoutReference
        >>> from ...messages import HumanMessage, AIMessage, ToolMessage
        >>>
        >>> client = AsyncOpenAI()
        >>> llm = llm_factory("gpt-4o-mini", client=client)
