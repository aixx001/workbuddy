...
class ExactMatch(BaseMetric):
    ...
    Usage:
        >>> from ..metrics.collections import ExactMatch
        >>>
        >>> metric = ExactMatch()
        >>>
...
class StringPresence(BaseMetric):
    ...
    Usage:
        >>> from ..metrics.collections import StringPresence
        >>>
...
class NonLLMStringSimilarity(BaseMetric):
    ...
    Usage:
        >>> from ..metrics.collections import NonLLMStringSimilarity, DistanceMeasure
        >>>
