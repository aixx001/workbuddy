...
class ContextPrecisionWithReference(BaseMetric):
    ...
    Usage:
        >>> import openai
        >>> from ...llms.base import llm_factory
        >>> from ...metrics.collections import ContextPrecisionWithReference
        >>>
        >>> # Setup dependencies
...
class ContextPrecisionWithoutReference(BaseMetric):
    ...
    Usage:
        >>> import openai
        >>> from ...llms.base import llm_factory
        >>> from ...metrics.collections import ContextPrecisionWithoutReference
        >>>
        >>> # Setup dependencies
        >>> client = openai.AsyncOpenAI()
        >>> llm = llm_factory("gpt-4o-mini", client=client)
...
class ContextPrecision(ContextPrecisionWithReference):
    ...
    Usage:
        >>> import openai
        >>> from ...llms.base import llm_factory
        >>> from ...metrics.collections import ContextPrecision
        >>>
        >>> # Setup dependencies
        >>> client = openai.AsyncOpenAI()
        >>> llm = llm_factory("gpt-4o-mini", client=client)
...
class ContextUtilization(ContextPrecisionWithoutReference):
    ...
    Usage:
        >>> import openai
        >>> from ...llms.base import llm_factory
        >>> from ...metrics.collections import ContextUtilization
        >>>
        >>> # Setup dependencies
        >>> client = openai.AsyncOpenAI()
        >>> llm = llm_factory("gpt-4o-mini", client=client)
