...
from ._analytics import EmbeddingUsageEvent, track
from .cache import CacheInterface, cacher
from .embeddings.utils import run_async_in_current_loop, validate_texts
...
class LlamaIndexEmbeddingsWrapper(BaseRagasEmbeddings):
    ...
    >>> from .embeddings import LlamaIndexEmbeddingsWrapper
...
def embedding_factory(
    ...
    **kwargs : Any
    ...
    # With caching
    from .cache import DiskCacheBackend
    ...
    if is_legacy_call:
        ...
        warnings.warn(
            ...
            "embedding_factory('openai', model='text-embedding-3-small', client=openai_client) "
            "or import providers directly: from .embeddings import OpenAIEmbeddings, GoogleEmbeddings, HuggingFaceEmbeddings",
            DeprecationWarning,
            stacklevel=2,
        )
