...
from ._analytics import LLMUsageEvent, track
from .cache import CacheInterface, cacher
from .exceptions import LLMDidNotFinishException
from .run_config import RunConfig, add_async_retry
...
class LangchainLLMWrapper(BaseRagasLLM):
    ...
    def __init__(
        ...
        warnings.warn(
            "LangchainLLMWrapper is deprecated and will be removed in a future version. "
            "Use llm_factory instead: "
            "from openai import OpenAI; from .llms import llm_factory; "
...
def llm_factory(
    ...
    **kwargs: t.Any,
    ...
    if adapter == "auto":
        from .llms.adapters import auto_detect_adapter
