...
from ._analytics import PromptUsageEvent, track
from ._version import __version__
from .callbacks import ChainType, new_group
from .exceptions import RagasOutputParserException
...
from .llms.base import BaseRagasLLM, InstructorBaseRagasLLM
...
class PydanticPrompt(BasePrompt, t.Generic[InputModel, OutputModel]):
    ...
    async def generate_multiple(
        ...
        if is_langchain_llm(llm):
            ...
            from .llms.base import InstructorLLM
